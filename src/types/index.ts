...
export interface Project {
  ...
  videoUrl?: string;
  /** Optional aspect ratio override (e.g. '16/9', '4/3', '9/16') */
  aspect?: string;
  /** If true, the project should show the external-watch fallback instead of attempting iframe embedding */
...
export interface PhotographerInfo {
  ...
  /** Optional short text shown over the portrait (falls back to `location`) */
  overlayText?: string;
