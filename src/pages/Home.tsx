...
import heroImage from '@/assets/home_cover.jpg';
  ...
  return (
    <>
      ...
      <div className="min-h-screen">
        {/* Hero */}
        <section className="relative h-dvh max-h-dvh w-full max-w-[100vw] overflow-hidden grain-overlay scanlines">
          ...
          <div className="relative z-10 h-full flex flex-col items-center justify-center px-6">
            ...
            >
              ...
              >
                ⏵ Personal Editor — Will Obey Deadlines
              </motion.p>
              ...
              >
                <Link
                  to="/portfolio"
                  className="inline-flex items-center gap-2 px-6 py-3 bg-retro-orange text-primary-foreground font-mono text-xs uppercase tracking-[0.2em] hover:bg-retro-orange/90 transition-colors"
                >
                  View Work
            ...
            <ScrollReveal>
              <div className="space-y-6">
                ...
                >
                  ...
                  <ArrowRight className="size-4 transition-transform group-hover:scale-105" />
                </Link>
              </div>
            </ScrollReveal>
          </div>
