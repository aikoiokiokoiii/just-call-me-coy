...
import { sendContactMessage, ContactSendError } from '@/lib/contact';
import {
  extractDomainFromEmail,
  hasPlausibleEmailDomain,
  ...
  email: z
    ...
    .pipe(
      z
        ...
        .refine((e) => hasPlausibleEmailDomain(e), {
          message: 'Use a real domain (e.g. gmail.com, your studio domain).',
        })
        .refine(
          (e) => {
            const d = extractDomainFromEmail(e);
            return d && !isDisposableEmailDomain(d);
          },
...
function friendlySendError(err: ContactSendError): string {
  const code = err.details?.code;
  if (code === 'missing_access_key') {
    return err.message;
  }
  return err.message || 'Something went wrong. Please email me directly at andrewnicolesanosa@gmail.com.';
}

/**
 * Contact form with retro styling, loading/success/error states.
 * Sends via Web3Forms API directly.
 */
