...
export function Lightbox({ 
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent 
        className="fixed inset-0 z-50 flex h-[100dvh] max-h-[100dvh] w-full max-w-[100vw] min-w-0 translate-x-0 translate-y-0 rounded-none border-none bg-black/95 p-0 sm:max-w-[100vw] [&>button]:hidden"
